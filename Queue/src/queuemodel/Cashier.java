...
/**
 * Cashier Class, extends the UniformCashier class.
 * Runs in a separate thread and serves customers.
 * @author Michael
 *
 */
public class Cashier extends UniformCashier implements Runnable
{
    ...
    /**
     * Cashier Constructor. Calls the UniformCashier super constructor, passing it the maxTime of service and the 
     * serviceQueue attached to the cashier. Sets the delay between checks for a customer. 
     * @param maxTime
     * @param checkTime
     * @param serviceQueue
     */
    ...
    /**
     * Checks the queue to see if there is a customer to be served. 
     * If there is a customer it calls the serviceQueue's serveCustomer method, and returns
    ...
    /**
     * Generates a service time that the cashier will take in serving the current customer. 
     */
